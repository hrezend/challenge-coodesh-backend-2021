...
export class tables1636414269013 implements MigrationInterface {
    name = 'tables1636414269013'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "coordinates" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "latitude" varchar, "longitude" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "street" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "number" integer, "name" varchar)`);
        await queryRunner.query(`CREATE TABLE "timezone" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "offset" varchar, "description" varchar)`);
        await queryRunner.query(`CREATE TABLE "location" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "city" varchar, "state" varchar, "country" varchar, "postcode" varchar, "streetId" integer, "coordinatesId" integer, "timezoneId" integer, CONSTRAINT "REL_7bec63c3f785b3963f06714933" UNIQUE ("streetId"), CONSTRAINT "REL_1e2b807a234c7fbf2c7b960cd9" UNIQUE ("coordinatesId"), CONSTRAINT "REL_1de3955a6c1c5ed0893b156259" UNIQUE ("timezoneId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_location" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "city" varchar, "state" varchar, "country" varchar, "postcode" varchar, "streetId" integer, "coordinatesId" integer, "timezoneId" integer, CONSTRAINT "REL_7bec63c3f785b3963f06714933" UNIQUE ("streetId"), CONSTRAINT "REL_1e2b807a234c7fbf2c7b960cd9" UNIQUE ("coordinatesId"), CONSTRAINT "REL_1de3955a6c1c5ed0893b156259" UNIQUE ("timezoneId"), CONSTRAINT "FK_7bec63c3f785b3963f067149332" FOREIGN KEY ("streetId") REFERENCES "street" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_1e2b807a234c7fbf2c7b960cd91" FOREIGN KEY ("coordinatesId") REFERENCES "coordinates" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_1de3955a6c1c5ed0893b1562599" FOREIGN KEY ("timezoneId") REFERENCES "timezone" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_location"("id", "city", "state", "country", "postcode", "streetId", "coordinatesId", "timezoneId") SELECT "id", "city", "state", "country", "postcode", "streetId", "coordinatesId", "timezoneId" FROM "location"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "location" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "city" varchar, "state" varchar, "country" varchar, "postcode" varchar, "streetId" integer, "coordinatesId" integer, "timezoneId" integer, CONSTRAINT "REL_7bec63c3f785b3963f06714933" UNIQUE ("streetId"), CONSTRAINT "REL_1e2b807a234c7fbf2c7b960cd9" UNIQUE ("coordinatesId"), CONSTRAINT "REL_1de3955a6c1c5ed0893b156259" UNIQUE ("timezoneId"))`);
        await queryRunner.query(`INSERT INTO "location"("id", "city", "state", "country", "postcode", "streetId", "coordinatesId", "timezoneId") SELECT "id", "city", "state", "country", "postcode", "streetId", "coordinatesId", "timezoneId" FROM "temporary_location"`);
